...
parser.add_argument('--name', default='Ablation_KD2', type=str, help='保存文件夹的名字')
...
parser.add_argument('--lambda_kd', default=2, type=float, help='知识蒸馏(互学习)的 Loss 权重')
        ...
        for data in dataloaders:
            ...
            with autocast():
                ...
                for i in range(opt.block):
                    ...
                    #         1.0 * (loss_tri_cnn + loss_tri_dino)
                    loss += loss_id_cnn + loss_id_dino + opt.lambda_kd * (loss_kl_cnn_learn + loss_kl_dino_learn)
